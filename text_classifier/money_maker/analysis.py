...
print(classifier_by_words.score(counted_by_words, genre_list))
...
print(classifier_by_words.predict(out))
print(forest_classifier.predict(out))
print(forest_classifier.score(counted_by_words,genre_list))
# print(out.shape)
#
# print(out[0,:].tolist())
print(len([x for x in ided_songs if x['genre'] == 'rock']))
